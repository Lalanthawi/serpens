        ...
        >
          <div className="card-body p-6 p-md-11 d-lg-flex flex-row align-items-lg-center justify-content-md-between text-center text-lg-start">
            <h3 className="display-2 mb-6 mb-lg-0 pe-lg-10 pe-xl-5 pe-xxl-18 text-white">
              We are trusted by over 100+ clients. Join them now and grow your
              business.
            </h3>
        ...
        <div className="text-inverse mx-md-5 mt-n15 mt-lg-0">
          <div className="row gy-6 gy-lg-0">
            <div className="col-lg-4">
              <div className="widget">
                <h3 className="h2 mb-3 text-white">Join Us</h3>
            ...
            <div className="col-md-4 col-lg-2">
              <div className="widget">
                ...
                <address> Serpens Technologies</address>
                <address>236 Katugastota, Kandy, Sri Lanka</address>
                <a href="mailto:first.last@email.com">hello@teamserpens.com</a>
                <br /> +94 (777) 14 24 33
              </div>
            </div>
          </div>
